...
def predict_drug(age, sex, blood_pressure, cholesterol, na_to_k_ratio):
    ...
    Args:
        ...
        na_to_k_ratin (float): Ratio of sodium to potassium in blood
    ...
    label = f"Predicted Drup: {predicted_drug}"
    return label
...
article = "This app is a part of the CI/CD for Machine Learning demonstration. \
